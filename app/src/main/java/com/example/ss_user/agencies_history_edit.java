...
public class agencies_history_edit extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agencies_history_edit);
        ...
        edit.setOnClickListener(v -> {
            Intent i = new Intent(agencies_history_edit.this, agencies_history_save.class);
            startActivity(i);
        });
    ...
    private void loadExpensesFromDatabase() {
        ...
        expenseRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(agencies_history_edit.this, "Failed to load expenses.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent i = new Intent(agencies_history_edit.this, expense_history_edit.class);
            startActivity(i);
        } else if (id == R.id.nav_create_user) {
            Toast.makeText(this, "Create User Clicked", Toast.LENGTH_SHORT).show();
            Intent i = new Intent(agencies_history_edit.this, expense_history_date_selection.class);
            startActivity(i);
